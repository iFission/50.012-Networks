...
def client_thread(clientFacingSocket):
	...
	try:
		...
		try:        
			...
			serverFacingSocket =  "hi"# Fill in start             # Fill in end
			...
			with open(file_to_use, "wb") as cacheFile:
				while True:
					buff = "hi" # Fill in start             # Fill in end
...
welcomeSocket = "hi"# Fill in start             # Fill in end
...
try: 
	while True:
		...
		clientFacingSocket, addr = "hi"#Fill in start             # Fill in end
